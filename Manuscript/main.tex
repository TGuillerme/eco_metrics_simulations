...
To ease interpretation of the results, w e centred the results for the 14 metrics for the 4 non null stressors by the results for the null stressor and then scaled them.
...
The results of these tests are displayed in supplementary tables 1 to 3 and in figure \ref{Fig:simulation_results} (for the non-null stressor, grey distributions are not clearly distinguishable from the null stressor).
...
We also added two marine species to the prehistoric species list; we compiled missing trait data for these two extinct species from \cite{sayol2021loss} data.
