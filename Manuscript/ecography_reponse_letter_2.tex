...
Regarding the statement in Lines 132–135:
...
Instead, it would be more intuitive and broadly applicable to simulate 2, 4, or 8 separate traits.
...
% TODO:  Change the trait definition from single to multiple. And say it's because in treats "traits" are treated as processes in n-dimensions but that we agree that this is adds extra complication here.
...
% TODO: add the table to the main text
% TODO: say we keep our definition of a trait as "measurable characteristic" (but that we use the more common defintion for the simulations)
...
% TODO: redo the supplementary plots but with different scale bars for every plot (and don't do the scaling)
