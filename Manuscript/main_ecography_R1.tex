...
% TODO:
% This illustrates the importance of setting the question + metric
...
% However, when measuring divergence using the Rao's quadratic entropy based on distance matrices, we did not find that.
