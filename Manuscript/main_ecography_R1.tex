...
%TM: can we make this interpretation? as this isn't the two time periods, i.e., there isn't a before and after 1500 comparison. It is all extinctions, and then just pre-1500 extinctions. 
%TM: And also see my previous comment - is not saying the opposite? That there was some mechanism pre 1500? But not when considering all extinctions?
%TODO@@@
...
%TG: TODO: check the pre-1500 story from email from Tom and Maria
