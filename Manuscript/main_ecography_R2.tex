...
% TODO: comment from pedro: I think I mantioned this before, but this uses a tree, even if it is not an histogram
\hline
...
% TG: TODO: something about Beta Diversity (Pedro's comment?)
\end{tabular}
