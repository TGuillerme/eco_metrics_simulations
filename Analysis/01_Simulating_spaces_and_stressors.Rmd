...
plot.1D <- function(data, reduction, null, main, col = c("blue", "orange"), pch = 19, trait = 1, xlab = "trait values", legend) {
    ...
    points(x = data[reduction, trait], y = rep(-1, sum(reduction)), col = "black", bg = col[2], pch = 21)
}
...
## Visualising the results
par(mfrow = c(2, 1))
plot.1D(trait_space, reduction = !competitive_exclusion, null = random_reduction, main = "1D null mechanism")
plot.2D(trait_space, reduction = !competitive_exclusion, null = random_reduction, main = "2D null mechanism")
```
...
## Visualising the results
par(mfrow = c(2, 1))
plot.1D(trait_space, reduction = equalizing_fitness, null = random_reduction, main = "1D null mechanism")
plot.2D(trait_space, reduction = equalizing_fitness, null = random_reduction, main = "2D null mechanism")
```
...
## Visualising the results
par(mfrow = c(2, 1))
plot.1D(trait_space, reduction = facilitation, null = random_reduction, main = "1D null mechanism")
plot.2D(trait_space, reduction = facilitation, null = random_reduction, main = "2D null mechanism")
```