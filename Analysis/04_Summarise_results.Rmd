...
empirical_results$empirical$results_table <- empirical_results$empirical$results_table[, c(historics, prehistorics, extants)]
```
...
## Pdf version
pdf(file = "../Manuscript/Figures/results_per_metric_per_stressor_emp.pdf", height = 9, width = 4.5)
