...
#TODO: reorder so to have rm2, rm3, rm1
...
fancy.plot(scaled_results_emp, col = col_vector, lm = NULL, null = null_differences_emp, metric.names = rev(fancy_names), , pch = c(19,15,17))
dev.off()
```
...
<!-- TODO: this caption is for the empirical data re-arranged as rm2, rm3, rm1 -->
