...
null_table_2d   <- fancy.table(null_differences_2d, columns = list(c(1,3), c(1,3)+4, c(1,3)+8, c(1,3)+12))
null_table_3d   <- fancy.table(null_differences_3d, columns = list(c(1,3), c(1,3)+4, c(1,3)+8, c(1,3)+12))
null_table_4d   <- fancy.table(null_differences_4d, columns = list(c(1,3), c(1,3)+4, c(1,3)+8, c(1,3)+12))
null_table_5d   <- fancy.table(null_differences_5d, columns = list(c(1,3), c(1,3)+4, c(1,3)+8, c(1,3)+12))
null_table_8d   <- fancy.table(null_differences_8d, columns = list(c(1,3), c(1,3)+4, c(1,3)+8, c(1,3)+12))
null_table_emp  <- fancy.table(null_differences_emp, columns = list(c(1,3), c(1,3)+4))
```
...
kable(model_table_emp, caption = "Results of the model scaled metric ~ removal level for the empirical data (5D)", align = "c")
```
```{r, echo = FALSE}
