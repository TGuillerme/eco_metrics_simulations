...
## placeholders
all_results_4d <- read.results("3d")
all_results_5d <- read.results("3d")
all_results_8d <- read.results("3d")
...
load("../Data/Processed/empirical_data-hist-extant.rda")
#empirical_data-hist-extant
empirical_hist_extant <- bkp

load("../Data/Processed/empirical_data-prehist-hist-prehist-extant.rda")
#empirical_data-prehist-hist-prehist-extant
empirical_prehist_hist_prehist_extant <- bkp
...
```{r}
## The plot
fancy.plot(scaled_results_4d, col = col_vector, lm = model_fits_4d, null = null_differences_4d, metric.names = fancy_names)
...
```{r}
## The plot
fancy.plot(scaled_results_5d, col = col_vector, lm = model_fits_5d, null = null_differences_5d, metric.names = fancy_names)
...
```{r}
## The plot
fancy.plot(scaled_results_8d, col = col_vector, lm = model_fits_8d, null = null_differences_8d, metric.names = fancy_names)
...
## legend
legend("topleft", col = metric_cols, pch = 19, legend = c("tree", "dissimilarity", "convex hull", "hypervolume", "probability density"))
```
