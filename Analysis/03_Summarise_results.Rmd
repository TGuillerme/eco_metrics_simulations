...
```{r, fig.height = 4, fig.width = 12}
plot.results(all_results, metric = "hypervolume_richness", level.names = removals, col = cols, legend.pos = "bottomright")
``` 

### Dispersion

```{r, fig.height = 4, fig.width = 12}
plot.results(all_results, metric = "hypervolume_dispersion", level.names = removals, col = cols, legend.pos = "bottomright")
``` 

### Regularity

```{r, fig.height = 4, fig.width = 12}
plot.results(all_results, metric = "hypervolume_regularity", level.names = removals, col = cols)
``` 
...
```{r, fig.height = 4, fig.width = 12}
plot.results(all_results, metric = "TPD_Richness", level.names = removals, col = cols, legend.pos = "bottomright")
``` 

### Evenness

```{r, fig.height = 4, fig.width = 12}
plot.results(all_results, metric = "TPD_Evenness", level.names = removals, col = cols, legend.pos = "bottomright")
``` 

### Divergence

```{r, fig.height = 4, fig.width = 12}
plot.results(all_results, metric = "TPD_Divergence", level.names = removals, col = cols, legend.pos = "bottomright")
``` 