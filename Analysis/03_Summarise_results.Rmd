...
new_names <- c("TPD[TPD]\nevenness",
               ...
               "convex hull[BAT]\nalpha",
               "dendrogram[BAT]\nalpha")
## TODO: add that to fancy plot as options
```
