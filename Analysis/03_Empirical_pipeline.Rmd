...
legend("topright", pch = 19, col = c("blue", "orange"), legend = c("Current species", "Species in 1500"))
dev.off()
...
data <- custom.subsets(pca$x, group = list(extant = extant_species, at_1500 = historic_species))
