...
Our question here could be whether the functional diversity of Hawaiian endemic birds decreased more in the last 500 years than ever before?
I.e. is the decrease in trait space occupancy greater in the present than in 1500 compared to all species that where recorded.
...
Here we will use the empirical data from @guillerme2024. The trait data is compiled from @tobias2022avonet, @pigot2020macroevolutionary and @sheard2020ecological and the extinction data is compiled from @matthews2023global.
It consists of a trait space of 118 species and 5 dimensions recorded in the last 125,000 years.
...
We can do that using already implemented metrics in `dispRity` (see `?dispRity.metric`) or by making or own metrics (see details below).
